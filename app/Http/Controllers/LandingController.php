...
class LandingController extends Controller
{
    ...
    public function bayar(Request $request){
        ...
        if(Auth::check()) {
            ...
            // Atau, jika pengguna tidak login, Anda dapat memberikan nilai default atau melakukan tindakan lain
            $userId = null; // atau nilai lain yang sesuai
        }
        ...
        $data = new transaksi([
            ...
            'limit' => $request->limit,
            'price' => $request->price,
            'status' => 'Paid', // Anda mungkin ingin menyesuaikan cara menentukan status pembayaran
        ]);
