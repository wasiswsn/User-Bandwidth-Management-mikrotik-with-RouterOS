...
<head>
  ...
  <title>Gmedia.Net-Form.Streaming</title>
        ...
        <div class="card shadow" style="width: 70rem;">
            <div class="card-body">
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item active">Voucher Streaming</li>
                </ol>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <div class="form-floating mb-3 mb-md-0">
                                        <input class="form-control" name="profile" value="Streaming" readonly />
